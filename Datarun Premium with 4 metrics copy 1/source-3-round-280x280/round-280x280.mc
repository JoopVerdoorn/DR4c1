...
class DeviceView extends PowerView {
	...
	function onUpdate(dc) {
	   ...
	   //! Display demo screen
		...
		if (licenseOK == true) {
			dc.drawText(140, 40, Graphics.FONT_XTINY, "DR4c1", Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
			dc.drawText(140, 70, Graphics.FONT_XTINY, "Version " + appversion, Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
